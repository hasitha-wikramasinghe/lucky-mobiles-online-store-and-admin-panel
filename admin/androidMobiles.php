        ...
        <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  ?>
                     ...
                     <input type="text" name="mobilename" class="form-control" value="<?php echo $mobilename; ?>" placeholder="Mobile Name" id="mobilename" required="Please Fill Content">
                     ...
                     <select name="catname" id="catname" class="form-control" require="Pleae fill this content"> 
                        <option value="<?php echo $catoname; ?>" class="">Please Select Category</option>
                                       ...
                                       <?php 
                                         while ($row = $result->fetch_array()):  ?>
                                            <tr>
                                                ...
                                                <td>
                                                   <a href="androidMobiles.php?edit=<?php echo $row['id'] ?>" class="btn btn-info">Update</a>
                                                   <a href="androidMobiles.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                         <?php endwhile; ?>
                                </table>
...
if(isset($_POST['save'])){
    ...
    $mysqli->query("INSERT INTO allproducts (catName, brandName, productName, productPrice, quantity, productImg) VALUES('$Catname','$Brandname','$Mobilename','$Productprice','$quantity','$Productimg')") or 
        ...
        header("location: androidMobiles.php");

           ?>
    <script type="text/javascript">
    top.window.location='androidMobiles.php';
    </script>
           <?php
}
