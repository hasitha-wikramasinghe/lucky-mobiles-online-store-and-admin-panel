           ...
           <div class="row">
                ...
                <div class="col-md-6">
                   ...
                   ?>
                     ...
                     <label class="androLabel">Mobile Name</label>
                     <input type="text" name="mobilename" class="form-control" value="<?php echo $mobilename; ?>" placeholder="Mobile Name" id="mobilename" required="fill the content">
                     ...
                     <input type="file" class="addImage" name="mobilepic" id="mobilepic" value="upload">
                     <br>
                     <?php if($update == true): ?>
                        ...
                        <table class="table">
                            <thead>
                               ...
                               <tr>
                                   ...
                                   <td>
                                   <a href="iphones.php?edit=<?php echo $row['id']; ?>" class="btn btn-info">Update</a>
                                   <a href="iphones.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                                   </td>
                               </tr>
                               <?php endwhile; ?> 
                        </table>
...
<?php 
   ...
   if(isset($_POST['save'])){
       ...
       $con->query("INSERT INTO allproducts (catName, brandName, productName, productPrice, quantity, productImg) VALUES ('$Catname','$Brandname','$MobileName', '$ProductPrice', '$quantity', '$ProductImg')") or
       die(mysqli_error($con)); 
       
       $_SESSION['message'] = "Record has been added!";
       $_SESSION['msg_type'] = "success";

       header ("location: iphones.php");
       ?>
       <script type="text/javascript">
       top.window.location='iphones.php';
       </script>
       <?php
        }
...
if(isset($_GET['delete'])){
    $id = $_GET['delete'];
    $con->query("DELETE FROM allproducts WHERE id=$id") or die($mysqli->error());
